...
public class EngDay1 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.engstudy1);

        Intent intent = getIntent();
        //MainActivity에서 number1 값을 가져와 num으로 선언
        int num = intent.getIntExtra("number1", 0);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                outIntent.putExtra("number1", curNum);
